...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		Object obj = null;
		Object paraOb = boundSql.getParameterObject();
		if (paraOb != null && paraOb instanceof HashMap) {
			HashMap<?, ?> paraMap = (HashMap) paraOb;
			for (Map.Entry ent : paraMap.entrySet()) {
				if (ent.getValue() instanceof Pagination) {
					obj = ent.getValue();
					break;
				}
			}
	...
	private String getMysqlPageSql(Pagination page, StringBuffer sqlBuffer) {
		if (page.getPageNumber() != null && page.getOffset() != null) {
